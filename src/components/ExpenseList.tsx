  ...
  if (expenses.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-sm font-medium text-primary mb-1">No expenses yet</h3>
        <p className="text-sm text-muted-foreground">Get started by creating a new expense.</p>
      </div>
    );
  }
